...
link_path "$DOTFILES_DIR/.config/fastfetch" "$HOME/.config/fastfetch"
link_path "$DOTFILES_DIR/.config/starship.toml" "$HOME/.config/starship.toml"
link_path "$DOTFILES_DIR/.config/systemd/user/kdeconnectd.service" "$HOME/.config/systemd/user/kdeconnectd.service"
